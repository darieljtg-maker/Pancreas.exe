...
import { Scale, Syringe, Lock, ArrowDown, ArrowUp, Minus, ClipboardCheck } from 'lucide-react';
 ...
 */
export default function CalculadoraPorciones({ glucosaInicial, tipoFijo, onUsar }) {
  ...
  const r = esHipo ? null : calcularPorcion({ tipo: tipoActivo, menu, glucosa: valor });
