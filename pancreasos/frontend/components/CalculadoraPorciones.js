      ...
      {r && (
        <div className="flex flex-col gap-3">
          ...
          <div className="rounded-2xl border-2 border-acento/50 bg-acento/10 p-5 text-center">
            ...
            {r.topado && r.ajusteTendencia > 0 && (
              <p className="mt-3 text-xs text-alto">
                La ración del plan se topó en 0 g. Estos {r.gramos} g son solo el colchón
                preventivo por la tendencia.
              </p>
            )}
          </div>
          ...
          <details className="rounded-xl border border-borde bg-superficie px-4 py-3">
            ...
            <dl className="mt-3 flex flex-col gap-1.5 text-sm">
              ...
              <div className="flex justify-between gap-3 border-t border-borde pt-1.5">
                <dt className="text-tenue">Plato base</dt>
              ...
              {(r.alba || r.igAlto) && (
                <div className="flex justify-between gap-3">
                  <dt className="text-tenue">Plato permitido</dt>
                  <dd className="font-mono">{r.totalTrasFactores} g</dd>
                </div>
              )}
              {/* La tendencia va al final: se suma entera, sin recortes. */}
              <div className="flex justify-between gap-3">
                <dt className="text-tenue">
                  Colchón por tendencia {r.tendencia?.glifo ?? ''}
                </dt>
